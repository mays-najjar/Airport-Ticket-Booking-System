...
namespace AirportBooking.Models
{
    public class Flight
    {
        ...
        public string DepartureAirport { get; set; } = string.Empty; [Required(ErrorMessage = "Arrival airport is required")][StringLength(50, ErrorMessage = "Arrival airport cannot exceed 50 characters")] public string ArrivalAirport { get; set; } = string.Empty; [Required(ErrorMessage = "Price is required")][Range(0.01, double.MaxValue, ErrorMessage = "Price must be greater than 0")] public decimal Price { get; set; }
